...
<details>
  ...
  <ol>
    ...
    <li><a href="#test-web-application">Test Web Application</a></li>
...
Additionally, you'll need an Ollama LLM model:
...
We conducted comprehensive testing to evaluate different LLM models for translation quality and performance. The testing used the Europarl parallel corpus with 1000 sentences, measuring BLEU scores and processing time.
...
- **Ollama Testing**: `llm_testing/ollama_testing/bleu_score.py`
- **Hugging Face Testing**: `llm_testing/huggingface_testing/bleu_score.py`
- **Complete Results**: `llm_testing/overall_results.md`

the result of the translations is also available in the directories `llm_testing/ollama_testing/results` and `llm_testing/huggingface_testing/results`
